...
function EditExamMark(props) {
    ...
    useEffect(() => {
        ...
        axios
            .get(`http://localhost:5000/exMarks/getExamMark?ID=${examId}`)
            .then((res) => {
                setValues({
    ...
    const handleSubmit = (event) => {
        ...
        axios
            .put(`http://localhost:5000/exMarks/updateExamMark?ID=${examId}`, values)
            .then((res) => {
